    ...
    return {
      ...
      controller: [ '$scope', function($scope) {
        ...
        $scope.options = {
          ...
          buttonSubmittingText: $scope.options.buttonSubmittingText || 'Working...',
          buttonSuccessText: $scope.options.buttonSuccessText || 'Done',
          ...
          buttonSubmittingIcon: $scope.options.buttonSubmittingIcon || 'fa fa-spinner',
          ...
          animationCompleteTime: $scope.options.animationCompleteTime || '1000',
