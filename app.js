...
'app_client/pages/files/fileDetails/fileDetails.controller.js',
...
'app_client/common/services/map.service.js',
...
fs.writeFile('public/javascripts/angular/nativeQDA.min.js', uglified.code, function (err){
    if(err) {
        ...
        console.log('Script generated and saved: nativeQDA.min.js');
    }
}); 
