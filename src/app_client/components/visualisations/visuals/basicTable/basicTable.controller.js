(function () {
	...
	/* @ngInject */
	function basicTableCtrl ($routeParams, analysisService, NgTableParams, bsLoadingOverlayService) {
		var vm = this;
		...
		function activate() {
			bsLoadingOverlayService.start({referenceId: 'analysis-basic-table'});
			analysisService.readWatsonAnalysis(analysisID)
			.then(function(response) {
				bsLoadingOverlayService.stop({referenceId: 'analysis-basic-table'});
